...
- 💻 **Full-Stack Web Development:** Building scalable MERN stack applications, personal SaaS products, and custom websites for clients from scratch.
- 🎨 **UI/UX & Digital Design:** Crafting modern, aesthetic user interfaces (especially loving dark themes!), professional logos, and premium marketing materials.
- 🤖 **AI-Powered Workflows:** Utilizing advanced AI tools to accelerate frontend development and generate creative, stylized 3D design assets.

---

## 💡 Core Strengths & Fun Facts

- ⚡ **Problem Solver:** I tackle complex bugs and logical challenges with a calm and strategic approach.
